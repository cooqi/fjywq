    ...
    pageApi(api) {
      common_vendor.index[api]({
        ...
        fail: (err) => {
          ...
          common_vendor.index.__f__("error", "at uni_modules/uni-list/components/uni-list-chat/uni-list-chat.vue:238", err.errMsg);
        }
      });
    }
  }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    r: common_vendor.t($options.isDraft ? $props.note.slice(14, -1) : $props.note),
