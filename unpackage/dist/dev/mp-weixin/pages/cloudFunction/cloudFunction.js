...
const _sfc_main = {
  ...
  methods: {
    ...
    handleDateClick(dateInfo) {
      common_vendor.index.__f__("log", "at pages/cloudFunction/cloudFunction.vue:61", "选中日期:", dateInfo);
      let { month, day, date } = dateInfo;
      this.getDetail(date);
    },
    // 月份变化事件
    handleMonthChange(monthInfo) {
      common_vendor.index.__f__("log", "at pages/cloudFunction/cloudFunction.vue:69", "月份变化:", monthInfo);
    },
    // 今日计划点击事件
    ...
    add() {
      ...
      common_vendor.tr.callFunction({
        ...
        common_vendor.index.__f__("error", "at pages/cloudFunction/cloudFunction.vue:99", err);
      });
    },
    remove() {
      common_vendor.index.showLoading({
      ...
      common_vendor.tr.callFunction({
        ...
        common_vendor.index.__f__("log", "at pages/cloudFunction/cloudFunction.vue:114", res);
      }).catch((err) => {
        common_vendor.index.hideLoading();
        common_vendor.index.showModal({
        ...
        common_vendor.index.__f__("error", "at pages/cloudFunction/cloudFunction.vue:121", err);
      });
    },
    update() {
      common_vendor.index.showLoading({
      ...
      common_vendor.tr.callFunction({
        ...
        common_vendor.index.__f__("log", "at pages/cloudFunction/cloudFunction.vue:140", res);
      }).catch((err) => {
        common_vendor.index.hideLoading();
        common_vendor.index.showModal({
        ...
        common_vendor.index.__f__("error", "at pages/cloudFunction/cloudFunction.vue:147", err);
      });
    },
    getList() {
      common_vendor.index.showLoading({
      ...
      common_vendor.tr.callFunction({
        ...
        common_vendor.index.__f__("error", "at pages/cloudFunction/cloudFunction.vue:172", err);
      });
    },
    getDetail(time) {
      ...
      this.dayInfo = this.allRili.filter((item) => {
        ...
        const d = t.getDate();
        common_vendor.index.__f__("log", "at pages/cloudFunction/cloudFunction.vue:187", time, month, day, m, d, item);
    ...
    useCommon() {
      common_vendor.tr.callFunction({
        ...
        common_vendor.index.__f__("error", "at pages/cloudFunction/cloudFunction.vue:205", err);
      });
    },
    toRedisPage() {
