...
export default {
  ...
  methods: {
    ...
    resetGame() {
      ...
      this.currentCupImage = 'https://env-00jy66xyyok3.normal.cloudstatic.cn/%E6%B8%B8%E6%88%8F/shengbei4.png'
      this.resultText = '准备掷杯'
      this.resultClass = ''
      // 使用现有的shengbei1.png作为默认提示图标
      this.holyTipImage = 'https://env-00jy66xyyok3.normal.cloudstatic.cn/%E6%B8%B8%E6%88%8F/shengbei1.png'
    }
  }
}
</script>
